...
public class MonsterDropViewer extends RSInterface {
        ...
        if (config == CONFIG_ID) {
            ...
            for (int index = 0; index < 80; index++) {
                ...
                if (index >= value) {
                    ...
                    container.children[240 + index] = 38003;
                    container.children[320 + index] = 38004;
                    container.children[400 + index] = 38005;
                }
            }
        }
    }
    ...
    public void OsDropViewer(TextDrawingArea[] tda) {
        ...
        main.height = 230;
        main.scrollMax = 2560;
        addSprite(38001, 3, dir);
        addSprite(38002, 4, dir);
        for (int i = 0; i < 40; i++) {
            main.child(i, 38001, 0, (i * 64));
            main.child(i + 40, 38002, 0, 32 + (i * 64));
        }
        addText(38003, "Amount:", tda, 0, 0xff9040, true, true);
        addText(38004, "Rarity:", tda, 0, 0xff9040, true, true);
        addText(38005, "Chance:", tda, 0, 0xff9040, true, true);
        for (int i = 0; i < 80; i++) {
            itemGroup(38010 + i, 1, 1, 1, 1, false, false);
            interfaceCache[38010 + i].inventoryItemId[0] = 14485;
            interfaceCache[38010 + i].inventoryAmounts[0] = 1;
            addText(38100 + i, "Item Name", tda, 1, 0xFFA500, false, true);
            addText(38200 + i, "1-50", tda, 0, 0xffffff, true, true);
            addText(38300 + i, "Common", tda, 0, 0xffffff, true, true);
            addText(38400 + i, "1/200", tda, 0, 0xffffff, true, true);
            int yy = (i * 32);
            main.child(80 + i, 38010 + i, 1, 0 + yy);
            main.child(160 + i, 38100 + i, 39, 6 + yy);
            main.child(240 + i, 38003, 175, 2 + yy);
            main.child(320 + i, 38004, 234, 2 + yy);
            main.child(400 + i, 38005, 293, 2 + yy);
            main.child(480 + i, 38200 + i, 175, 14 + yy);
            main.child(560 + i, 38300 + i, 234, 14 + yy);
            main.child(640 + i, 38400 + i, 293, 14 + yy);
        }
