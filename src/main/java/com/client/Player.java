...
//			primary_index = super.primaryanim_frameindex;
//
//			if (super.secondaryanim >= 0 && super.secondaryanim != super.readyanim) {
//				secondary_index = super.secondaryanim_frameindex;
//			}
//			if (animation.offhand >= 0) {
//				seq_offhand = animation.offhand;
//				playermodel_uid += seq_offhand - equipment[5] << 40;
//			}
//			if (animation.mainhand >= 0) {
//				seq_mainhand = animation.mainhand;
//				playermodel_uid += seq_mainhand - equipment[3] << 48;
//			}
//		} else if (super.secondaryanim >= 0) {
//			primary_index = super.secondaryanim_frameindex;
//		}
