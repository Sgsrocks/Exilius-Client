...
public final class MapRegion {
					...
					if (l6 >= 1 && l6 < regionSizeX - 1) {
						...
						for (int k17 = -5; k17 < regionSizeY + 5; k17++) {
							...
							if (k17 >= 1 && k17 < regionSizeY - 1 && (!lowMem || (tileFlags[0][l6][k17] & 2) != 0 || (tileFlags[z][l6][k17] & 0x10) == 0 && getCollisionPlane(k17, z, l6) == anInt131)) {
								if (z < maximumPlane)
									maximumPlane = z;
								int l18 = underlays[z][l6][k17]& 0x3FFF;
								int i19 = overlays[z][l6][k17]& 0x3FFF;
								if (l18 > 0 || i19 > 0) {
									...
									if (i19 == 0) {
										...
										int lightness;
										if (texture >= 0) {
											minimapColor = Rasterizer3D.textureLoader.getAverageTextureHSL(texture);
											encodedTile = -1;
	...
	private void renderObject(int y, SceneGraph scene, CollisionMap class11, int type, int z, int x, int id, int rotation) {
		...
		if (type == 22) {
			...
			Object obj;
			if (definition.readyanim == -1 && definition.configs == null) {
				obj = definition.modelAt(22, rotation, center, east, northEast, north, -1, null);
			} else {
				obj = new SceneObject(id, rotation, 22, east, northEast, center, north, definition.readyanim,
						true);
			}
		...
		if (type == 10 || type == 11) {
			Object obj1;
			if (definition.readyanim == -1 && definition.configs == null) {
				obj1 = definition.modelAt(10, rotation, center, east, northEast, north, -1, null);
			} else {
				obj1 = new SceneObject(id, rotation, 10, east, northEast, center, north, definition.readyanim,
						true);
			}
			if (obj1 != null) {
				int i5 = 0;
				...
				if (scene.addTiledObject(key, config, mean, l4, ((Renderable) (obj1)), j4, z, i5, y, x)
					...
					if (obj1 instanceof Model) {
						...
						model = definition.modelAt(10, rotation, center, east, northEast, north, -1, null);
					}
					if (model != null) {
			...
			if (definition.blockWalk && class11 != null) {
				class11.method212(definition.blocksProjectile, definition.length, definition.width, x, y, rotation);
			}
			return;
		}
		if (type >= 12) {
			Object obj2;
			if (definition.readyanim == -1 && definition.configs == null) {
				obj2 = definition.modelAt(type, rotation, center, east, northEast, north, -1, null);
			} else {
				obj2 = new SceneObject(id, rotation, type, east, northEast, center, north, definition.readyanim,
						true);
			}
			...
			if (definition.blockWalk && class11 != null) {
				class11.method212(definition.blocksProjectile, definition.length, definition.width,
						x, y, rotation);
			}
			return;
		}
		if (type == 0) {
			Object obj3;
			if (definition.readyanim == -1 && definition.configs == null) {
				obj3 = definition.modelAt(0, rotation, center, east, northEast, north, -1, null);
			} else {
				obj3 = new SceneObject(id, rotation, 0, east, northEast, center, north, definition.readyanim,
						true);
			}
		...
		if (type == 1) {
			Object obj4;
			if (definition.readyanim == -1 && definition.configs == null) {
				obj4 = definition.modelAt(1, rotation, center, east, northEast, north, -1, null);
			} else {
				obj4 = new SceneObject(id, rotation, 1, east, northEast, center, north, definition.readyanim,
						true);
			}
		...
		if (type == 2) {
			...
			Object obj12;
			if (definition.readyanim == -1 && definition.configs == null) {
				obj11 = definition.modelAt(2, 4 + rotation, center, east, northEast, north, -1, null);
				obj12 = definition.modelAt(2, i3, center, east, northEast, north, -1, null);
			} else {
				obj11 = new SceneObject(id, 4 + rotation, 2, east, northEast, center, north, definition.readyanim,
						true);
				obj12 = new SceneObject(id, i3, 2, east, northEast, center, north, definition.readyanim,
						true);
			}
		...
		if (type == 3) {
			Object obj5;
			if (definition.readyanim == -1 && definition.configs == null) {
				obj5 = definition.modelAt(3, rotation, center, east, northEast, north, -1, null);
			} else {
				obj5 = new SceneObject(id, rotation, 3, east, northEast, center, north, definition.readyanim,
						true);
			}
		...
		if (type == 9) {
			Object obj6;
			if (definition.readyanim == -1 && definition.configs == null) {
				obj6 = definition.modelAt(type, rotation, center, east, northEast, north, -1, null);
			} else {
				obj6 = new SceneObject(id, rotation, type, east, northEast, center, north, definition.readyanim,
						true);
			}
		...
		if (type == 4) {
			Object obj7;
			if (definition.readyanim == -1 && definition.configs == null) {
				obj7 = definition.modelAt(4, 0, center, east, northEast, north, -1, null);
			} else {
				obj7 = new SceneObject(id, 0, 4, east, northEast, center, north, definition.readyanim,
						true);
			}
		...
		if (type == 5) {
			...
			Object obj13;
			if (definition.readyanim == -1 && definition.configs == null) {
				obj13 = definition.modelAt(4, 0, center, east, northEast, north, -1, null);
			} else {
				obj13 = new SceneObject(id, 0, 4, east, northEast, center, north, definition.readyanim,
						true);
			}
		...
		if (type == 6) {
			Object obj8;
			if (definition.readyanim == -1 && definition.configs == null) {
				obj8 = definition.modelAt(4, 0, center, east, northEast, north, -1, null);
			} else {
				obj8 = new SceneObject(id, 0, 4, east, northEast, center, north, definition.readyanim,
						true);
			}
		...
		if (type == 7) {
			Object obj9;
			if (definition.readyanim == -1 && definition.configs == null) {
				obj9 = definition.modelAt(4, 0, center, east, northEast, north, -1, null);
			} else {
				obj9 = new SceneObject(id, 0, 4, east, northEast, center, north, definition.readyanim,
						true);
			}
		...
		if (type == 8) {
			Object obj10;
			if (definition.readyanim == -1 && definition.configs == null) {
				obj10 = definition.modelAt(4, 0, center, east, northEast, north, -1, null);
			} else {
				obj10 = new SceneObject(id, 0, 4, east, northEast, center, north, definition.readyanim,
						true);
			}
	...
	private void readTile(int i, int j, Buffer stream, int k, int l, int i1, int k1) {
		try {
			if (k >= 0 && k < 104 && i >= 0 && i < 104) {
				tileFlags[l][k][i] = 0;
				do {
					int l1 = stream.get_unsignedshort();
					if (l1 == 0)
						if (l == 0) {
					...
					if (l1 <= 49) {
						overlays[l][k][i] = (short) stream.get_short();
			...
			do {
				int i2 = stream.get_unsignedshort();
				if (i2 == 0)
					break;
				if (i2 == 1) {
			...
			do {
				...
				do {
					...
					if (j3 == i && i3 >= i1 && i3 < i1 + 8 && l2 >= k && l2 < k + 8) {
						...
						int j4 = j + ChunkUtil.method157(j1, class46.width, i3 & 7, l2 & 7, class46.length);
						int k4 = k1 + ChunkUtil.method158(l2 & 7, class46.width, j1, class46.length, i3 & 7);
	...
	public static void placeObject(SceneGraph worldController, int rotation, int regionY, int type, int plane,
		...
		if (type == 22) {
			Object obj;
			if (definition.readyanim == -1 && definition.configs == null) {
				obj = definition.modelAt(22, rotation, l1, i2, j2, k2, -1, null);
			} else {
				obj = new SceneObject(j1, rotation, 22, i2, j2, l1, k2, definition.readyanim, true);
			}
		...
		if (type == 10 || type == 11) {
			Object obj1;
			if (definition.readyanim == -1 && definition.configs == null) {
				obj1 = definition.modelAt(10, rotation, l1, i2, j2, k2, -1, null);
			} else {
				obj1 = new SceneObject(j1, rotation, 10, i2, j2, l1, k2, definition.readyanim, true);
			}
			if (obj1 != null) {
				int j5 = 0;
				if (type == 11) {
			...
			if (definition.blockWalk) {
				class11.method212(definition.blocksProjectile, definition.length, definition.width, regionX, regionY, rotation);
			}
			return;
		}
		if (type >= 12) {
			Object obj2;
			if (definition.readyanim == -1 && definition.configs == null) {
				obj2 = definition.modelAt(type, rotation, l1, i2, j2, k2, -1, null);
			} else {
				obj2 = new SceneObject(j1, rotation, type, i2, j2, l1, k2, definition.readyanim, true);
			}
		...
		if (type == 0) {
			Object obj3;
			if (definition.readyanim == -1 && definition.configs == null) {
				obj3 = definition.modelAt(0, rotation, l1, i2, j2, k2, -1, null);
			} else {
				obj3 = new SceneObject(j1, rotation, 0, i2, j2, l1, k2, definition.readyanim, true);
			}
		...
		if (type == 1) {
			Object obj4;
			if (definition.readyanim == -1 && definition.configs == null) {
				obj4 = definition.modelAt(1, rotation, l1, i2, j2, k2, -1, null);
			} else {
				obj4 = new SceneObject(j1, rotation, 1, i2, j2, l1, k2, definition.readyanim, true);
			}
		...
		if (type == 2) {
			...
			Object obj12;
			if (definition.readyanim == -1 && definition.configs == null) {
				obj11 = definition.modelAt(2, 4 + rotation, l1, i2, j2, k2, -1, null);
				obj12 = definition.modelAt(2, j3, l1, i2, j2, k2, -1, null);
			} else {
				obj11 = new SceneObject(j1, 4 + rotation, 2, i2, j2, l1, k2, definition.readyanim, true);
				obj12 = new SceneObject(j1, j3, 2, i2, j2, l1, k2, definition.readyanim, true);
			}
		...
		if (type == 3) {
			Object obj5;
			if (definition.readyanim == -1 && definition.configs == null) {
				obj5 = definition.modelAt(3, rotation, l1, i2, j2, k2, -1, null);
			} else {
				obj5 = new SceneObject(j1, rotation, 3, i2, j2, l1, k2, definition.readyanim, true);
			}
		...
		if (type == 9) {
			Object obj6;
			if (definition.readyanim == -1 && definition.configs == null) {
				obj6 = definition.modelAt(type, rotation, l1, i2, j2, k2, -1, null);
			} else {
				obj6 = new SceneObject(j1, rotation, type, i2, j2, l1, k2, definition.readyanim, true);
			}
		...
		if (type == 4) {
			...
			if (definition.readyanim == -1 && definition.configs == null) {
				...
				obj7 = new SceneObject(j1, 0, 4, i2, j2, l1, k2, definition.readyanim, true);
			}
		...
		if (type == 5) {
			...
			if (definition.readyanim == -1 && definition.configs == null) {
				...
				obj13 = new SceneObject(j1, 0, 4, i2, j2, l1, k2, definition.readyanim, true);
			}
		...
		if (type == 6) {
			...
			if (definition.readyanim == -1 && definition.configs == null) {
				...
				obj8 = new SceneObject(j1, 0, 4, i2, j2, l1, k2, definition.readyanim, true);
			}
		...
		if (type == 7) {
			...
			if (definition.readyanim == -1 && definition.configs == null) {
				...
				obj9 = new SceneObject(j1, 0, 4, i2, j2, l1, k2, definition.readyanim, true);
			}
		...
		if (type == 8) {
			...
			if (definition.readyanim == -1 && definition.configs == null) {
				...
				obj10 = new SceneObject(j1, 0, 4, i2, j2, l1, k2, definition.readyanim, true);
			}
	...
	public static void requestModelPreload(byte[] is) {
		label0: {
			...
			int l = -1;
			do {
				int i1 = stream.get_unsignedsmart_byteorshort();
				if (i1 == 0)
					break label0;
				l += i1;
				int j1 = 0;
				do {
					int k1 = stream.get_unsignedsmart_byteorshort();
					if (k1 == 0)
						break;
					j1 += k1 - 1;
					int j2 = j1 >> 12;
	...
	// with JODE
	{
		...
		for (;;) {
			...
			for (;;) {
				if (bool_255_) {
					int i_256_ = stream.get_unsignedsmart_byteorshort();
					if (i_256_ == 0)
						break;
					stream.get_unsignedbyte();
				} else {
					int i_257_ = stream.get_unsignedsmart_byteorshort();
					if (i_257_ == 0)
						break;
					i_254_ += i_257_ - 1;
