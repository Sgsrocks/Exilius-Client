...
public final class Rasterizer3D extends Rasterizer2D {
    ...
    public static void drawTexturedTriangle(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, int var13, int var14, int var15, int var16, int var17, int textureID) {
        ...
        if (texturePixels == null) {
            hsl_average = textureLoader.getAverageTextureHSL(textureID);
            drawShadedTriangle(var0, var1, var2, var3, var4, var5, adjust_light(hsl_average, var6), adjust_light(hsl_average, var7), adjust_light(hsl_average, var8));
        } else {
    ...
    static final int adjust_light(int hsl, int lightness) {
        lightness = (hsl & 127) * lightness >> 7; // L: 2651
        if (lightness < 2) { // L: 2652
            lightness = 2;
        } else if (lightness > 126) { // L: 2653
            lightness = 126;
        }

        return (hsl & 65408) + lightness; // L: 2654
    }
